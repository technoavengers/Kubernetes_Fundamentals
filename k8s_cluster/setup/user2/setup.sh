...
aws s3api create-bucket \
    --bucket kops-technoavengers-user2-com-state-store \
    --region us-east-1
...
### * edit this cluster with: kops edit cluster technoavengers.user2.k8s.local
### * edit your node instance group: kops edit ig --name=technoavengers.user2.k8s.local nodes-us-east-1a
### * edit your master instance group: kops edit ig --name=technoavengers.user2.k8s.local master-us-east-1a
