...
### * edit this cluster with: kops edit cluster technoavengers.instructor.k8s.local
### * edit your node instance group: kops edit ig --name=technoavengers.instructor.k8s.local nodes-us-east-2a
### * edit your master instance group: kops edit ig --name=technoavengers.instructor.k8s.local master-us-east-2a
