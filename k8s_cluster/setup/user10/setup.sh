...
aws s3api create-bucket \
    --bucket kops-technoavengers-user10-com-state-store \
    --region us-east-1
...
### * edit this cluster with: kops edit cluster technoavengers.user10.k8s.local
### * edit your node instance group: kops edit ig --name=technoavengers.user10.k8s.local nodes-us-east-2a
### * edit your master instance group: kops edit ig --name=technoavengers.user10.k8s.local master-us-east-2a
